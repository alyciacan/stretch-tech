describe("empty spec", () => {
  beforeEach(() => {
    cy.intercept("GET", "https://www.rijksmuseum.nl/api/en/collection/#SK-C-5?key=AgQXh8Og", {fixture: "painting1.json"}).as("artObject");
  ...
  it("should be able to go back home", () => {
    ...
    cy.intercept("GET", "https://www.rijksmuseum.nl/api/en/collection?key=AgQXh8Og&involvedMaker=Rembrandt+van+Rijn", {fixture: "allPaintings.json"}).as("artObject");
